...
-> This question I used a trick :)) I tried to enter many answers but they all aren't right. So I skiped this question. And when I got to question 12, I found the answer by filter eventId 4720 in Security event log. It is S-1-5-21-953115734-2025219997-3674921352-1002, I only need to remove 1002.
<br><br>
...
-> I use MFT Explorer to watch $MFT file. I found in the folder Downloads of user Alpha had mimikatz_trunk.zip. And in prefetch, I explored 2 prefetch files of mimikatz.exe<br>
-> mimikatz.exe
<br>
